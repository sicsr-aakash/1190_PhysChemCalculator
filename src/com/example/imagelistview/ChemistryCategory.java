...
public class ChemistryCategory extends ActionBarActivity{
	ListView lv;
    Context context;
 
    ArrayList prgmName;
    public static int [] prgmImages={R.drawable.as,R.drawable.mc,R.drawable.gls,R.drawable.anb};
    public static String [] prgmNameList={"Atomic Structure","Molecular Chemistry",
    	"Gas Liquid & Solution","Acid & Base"};
    @Override
