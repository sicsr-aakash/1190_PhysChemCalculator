...
public class AtomicStructCat extends ActionBarActivity{
	ListView lv;
    Context context;
 
    ArrayList prgmName;
    public static int [] prgmImages={R.drawable.awc,R.drawable.sc,R.drawable.pec};
    public static String [] prgmNameList={"Atomic Weight","Speed","Energy Of Proton"};
    @Override
