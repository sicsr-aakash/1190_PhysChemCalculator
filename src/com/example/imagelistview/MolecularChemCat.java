...
public class MolecularChemCat extends ActionBarActivity{
	ListView lv;
    Context context;
 
    ArrayList prgmName;
    public static int [] prgmImages={R.drawable.atmc,R.drawable.mmc};
    public static String [] prgmNameList={"Atoms To Moles","Molecular Mass Using Gram-molecular Volume Law"};
    @Override
