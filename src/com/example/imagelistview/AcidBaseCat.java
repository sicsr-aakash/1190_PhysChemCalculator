...
public class AcidBaseCat extends ActionBarActivity{
	ListView lv;
    Context context;
 
    ArrayList prgmName;
    public static int [] prgmImages={R.drawable.acwc,R.drawable.emac};
    public static String [] prgmNameList={"Acid Weight","Equivalent Mass Of Acid"};
    @Override
