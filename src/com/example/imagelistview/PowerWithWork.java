...
public class PowerWithWork extends Activity{
   ...
   BuildLinear("Formula :","Work= Power X Time");
		   ...
		   b1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(field2.trim().equals("")){
						...
						res.setText("Resultant Power: "+String.valueOf(mass)+" Watt");
					...
					if(field3.trim().equals("")){
						...
						res.setText("Resultant Time: "+String.valueOf(acc)+" sec");
