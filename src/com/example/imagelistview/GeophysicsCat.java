...
public class GeophysicsCat extends ActionBarActivity{
	ListView lv;
    Context context;
 
    ArrayList prgmName;
    public static int [] prgmImages={R.drawable.os,R.drawable.los};
    public static String [] prgmNameList={"Orbit Speed Calculation","Luminosity Of Star"};
    @Override
